...
(
    ...
    template_auth    TINYINT     NOT NULL DEFAULT 0 COMMENT '模板权限（0：共享，1：专享）',
    audit_status     VARCHAR(2)  NOT NULL default '0' COMMENT '审核状态（0：待审核，1：审核通过，2：审核拒绝）',
    ...
    created_at       TIMESTAMP            DEFAULT CURRENT_TIMESTAMP COMMENT '模板创建时间',
    updated_at       TIMESTAMP            DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '模板更新时间',
